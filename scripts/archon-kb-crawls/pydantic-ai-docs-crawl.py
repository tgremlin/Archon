#!/usr/bin/env python3
"""
Pydantic AI Documentation Crawl Script for Archon
Updated: 2026-01-01
...
def print_summary(result: dict) -> None:
    ...
    if status == "completed":
        print("\nThe Pydantic AI documentation is now available in Archon!")
...
def main() -> int:
    """Main entry point."""
    print(f"\n{'#'*60}")
    print("# Pydantic AI Documentation Crawl for Archon")
    ...
    print("This will crawl the Pydantic AI llms-full.txt file and create a single")
