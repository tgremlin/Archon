#!/usr/bin/env python3
"""
CrewAI Documentation Crawl Script for Archon
Updated: 2026-01-01
...
1. One source instead of 50+ separate ones
...
def print_summary(result: dict) -> None:
    ...
    if status == "completed":
        print("\nThe CrewAI documentation is now available in Archon!")
...
def main() -> int:
    """Main entry point."""
    print(f"\n{'#'*60}")
    print("# CrewAI Documentation Crawl for Archon")
    ...
    print("This will crawl the CrewAI llms-full.txt file and create a single")
