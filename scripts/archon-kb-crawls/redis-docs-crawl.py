#!/usr/bin/env python3
"""
Redis Documentation Crawl Script for Archon
Updated: 2026-01-01
...
def print_summary(result: dict) -> None:
    ...
    if status == "completed":
        print("\nThe Redis documentation is now available in Archon!")
...
def main() -> int:
    """Main entry point."""
    print(f"\n{'#'*60}")
    print("# Redis Documentation Crawl for Archon")
    ...
    print("This will crawl the Redis llms.txt file and create a single")
